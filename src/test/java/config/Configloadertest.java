 ...
 *
 * <p>These tests use the real config.properties (petrinet.number=1 → travelAgencySystem) located in
 * src/test/resources/ — same files as production, values hardcoded from the actual .properties so
