/**
 * Entry point of the Concurrency Monitor application. Loads the Petri net and configuration, then
 * prints a summary.
 *
...
/*public class Main {
  ...
  public static void main(String[] args) {
    ...
    System.out.println(
        "Initial marking  : " + arrayToString(PetrinetLoader.getInitialMarkingVector()));
    System.out.println(
        "Temporal trans.  : " + arrayToString(PetrinetLoader.getTemporalTransitionsVector()));
